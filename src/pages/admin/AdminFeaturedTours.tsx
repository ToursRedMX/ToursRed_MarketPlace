            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-amber-300"
                />
              </div>
              <select
                value={slotStatusFilter}
                onChange={e => setSlotStatusFilter(e.target.value as typeof slotStatusFilter)}
                className="text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-hidden focus:ring-2 focus:ring-amber-300 bg-white"
              >
                          ...
                          <div>
                            ...
                            {editing ? (
                              <input
                                ...
                                className="w-full text-sm border border-gray-200 rounded-lg px-3 py-1.5 focus:outline-hidden focus:ring-2 focus:ring-amber-300"
                              />
                            ) : (
                            ...
                            {editing ? (
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  className="w-full pl-6 pr-3 py-1.5 text-sm border border-amber-300 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-amber-300"
                                />
                              </div>
                            ) : (
