          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            {pdfUrl && (
              <a
                ...
                className="mt-4 inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition-colors w-full justify-center"
              >
