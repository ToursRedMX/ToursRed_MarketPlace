        ...
        <div className="relative container-custom py-24 md:py-36">
          <div className="max-w-3xl flex flex-col items-start">
            ...
            <div className="animate-slide-up">
              <SearchBox className="bg-blue-50/90 backdrop-blur-xs" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={title}
                className="flex items-start gap-4 p-5 rounded-xl border border-blue-100 bg-blue-50/40 hover:bg-blue-50 hover:border-blue-200 hover:shadow-xs transition-all duration-200"
              >
