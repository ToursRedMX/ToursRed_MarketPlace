...
casos.push(() => {
  ...
  // cuando la migracion 20260910240000 agrego la tabla y el bloque 19 de la
  ...
  assert.ok(!/gastos de operacion no estan incluidos/i.test(tsx),
    'el aviso de que los gastos no se capturan ya no es cierto: la tabla existe desde 20260910240000');
