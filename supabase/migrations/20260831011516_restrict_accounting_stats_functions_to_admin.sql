...
--
--   version: 20260831011516
--   name:    restrict_accounting_stats_functions_to_admin
--
...
-- Antes cualquier usuario autenticado (incluyendo viajeros) podia llamar
-- estas dos funciones y ver estadisticas agregadas de negocio (total
-- facturado, estado de sincronizacion contable). No es dinero ni PII, pero
-- es informacion de negocio que no deberia ser publica. Se restringe a
-- admin/super_admin/accountant, igual que get_gift_card_accounting_summary.
