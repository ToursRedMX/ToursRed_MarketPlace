...
--
--   version: 20260830233609
--   name:    cleanup_calculate_booking_financial_breakdown_dead_code
--
...
-- Tasa real via get_effective_commission_rates (mas confiable que derivarla
-- de un cociente -- ver fix del 30-ago sobre descuentos), usada para el
-- calculo de comision sobre penalizaciones por atraso mas abajo.
