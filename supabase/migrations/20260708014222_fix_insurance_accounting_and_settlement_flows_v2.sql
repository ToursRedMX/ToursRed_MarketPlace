...
--
--   version: 20260708014222
--   name:    fix_insurance_accounting_and_settlement_flows_v2
--
...
-- 2) Config de economics del seguro
...
-- 3) Fix create_accounting_entry_for_booking
...
-- 4) Tabla + funcion + trigger: liquidacion a la aseguradora (Flujo B)
...
-- 5) Tabla + funcion + trigger: comision recibida de la aseguradora (Flujo C)
