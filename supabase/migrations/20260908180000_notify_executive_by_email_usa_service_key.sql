...
-- ver 20260821212354). El header sigue siendo `apikey`, no Authorization:
-- el gateway de Supabase rechaza el formato nuevo de llaves en
-- Authorization: Bearer, y _shared/auth.ts mira los dos sitios justo por esto.
--
