...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    EdgeRuntime.waitUntil(
      ...
      }).then((r: unknown) => vigilarResultado(r, "generate-post-booking-insurance-cfdi -> send-cfdi-email")).catch((e: unknown) => registrarFallo("generate-post-booking-insurance-cfdi -> send-cfdi-email", e))
    );
