...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    EdgeRuntime.waitUntil(
      ...
      }).then((r: unknown) => vigilarResultado(r, "generate-optional-service-cfdi -> send-cfdi-email")).catch((e: unknown) => registrarFallo("generate-optional-service-cfdi -> send-cfdi-email", e))
    );
